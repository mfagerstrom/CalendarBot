...
After every changeset you make (ie. when you stop thinking/working), run npm run lint and npm run compile with a 30 second timeout.
...
preface all table names with "CALENDAR_"
